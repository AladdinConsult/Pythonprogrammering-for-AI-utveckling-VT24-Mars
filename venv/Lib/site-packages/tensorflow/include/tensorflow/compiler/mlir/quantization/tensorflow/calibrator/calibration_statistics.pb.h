...
class CalibrationStatistics_HistogramStatistics final :
 ...
 public:
  ...
  private:
  int64_t _internal_hist_freq(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
      _internal_hist_freq() const;
  void _internal_add_hist_freq(int64_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
      _internal_mutable_hist_freq();
  public:
  int64_t hist_freq(int index) const;
  void set_hist_freq(int index, int64_t value);
  void add_hist_freq(int64_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
      hist_freq() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
      mutable_hist_freq();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t > hist_freq_;
    mutable std::atomic<int> _hist_freq_cached_byte_size_;
    float bin_width_;
    float lower_bound_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
inline int64_t CalibrationStatistics_HistogramStatistics::_internal_hist_freq(int index) const {
  return _impl_.hist_freq_.Get(index);
}
inline int64_t CalibrationStatistics_HistogramStatistics::hist_freq(int index) const {
...
inline void CalibrationStatistics_HistogramStatistics::set_hist_freq(int index, int64_t value) {
...
inline void CalibrationStatistics_HistogramStatistics::_internal_add_hist_freq(int64_t value) {
  _impl_.hist_freq_.Add(value);
}
inline void CalibrationStatistics_HistogramStatistics::add_hist_freq(int64_t value) {
